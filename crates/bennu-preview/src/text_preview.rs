...
pub const TEXT_PREVIEW_LINE_LIMIT: usize = 10_000;
pub const TEXT_PREVIEW_INITIAL_LINE_LIMIT: usize = 50;
pub const TEXT_PREVIEW_CHUNK_LINE_LIMIT: usize = 500;
pub const TEXT_PREVIEW_LOAD_MORE_THRESHOLD: usize = 10;
pub const TEXT_PREVIEW_TEXT_SIZE: f32 = 16.0;
pub const TEXT_PREVIEW_LINE_HEIGHT: f32 = 1.3;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum TextPreviewFormat {
    Plain,
    Markdown,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct TextPreviewLineLimitNotice {
    total_line_count: usize,
}

impl TextPreviewLineLimitNotice {
    pub fn for_total_line_count(total_line_count: usize) -> Option<Self> {
...
pub struct TextPreviewChunkRequest {
    pub path: PathBuf,
    pub generation: u64,
    pub start_offset: u64,
    pub loaded_line_count: usize,
    pub line_limit: usize,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct TextPreviewChunk {
    pub start_offset: u64,
    pub content: String,
    pub line_count: usize,
    pub next_offset: Option<u64>,
    pub line_limit_notice: Option<TextPreviewLineLimitNotice>,
}
...
impl TextPreviewDocument {
    ...
    pub fn line_number_digit_count(&self) -> usize {
    ...
    pub fn line_limit_notice(&self) -> Option<TextPreviewLineLimitNotice> {
        self.line_limit_notice
    }

    pub fn chunk_error(&self) -> Option<&str> {
        self.chunk_error.as_deref()
    }

    pub fn markdown_preview_mode(&self) -> MarkdownPreviewMode {
        self.markdown_preview_mode
    }

    pub fn select_markdown_preview_mode(&mut self, mode: MarkdownPreviewMode) {
        self.markdown_preview_mode = mode;
    }

    pub fn is_scrolled_to_preview_end(&self) -> bool {
    ...
    pub fn request_next_chunk_for_rendered_markdown(
        &mut self,
        offset_y: f32,
        viewport_height: f32,
        content_height: f32,
    ...
    pub fn append_chunk(&mut self, chunk: TextPreviewChunk, viewport_height: f32) -> bool {
    ...
    pub fn accept_chunk_error(&mut self, start_offset: u64, error: String) -> bool {
...
pub fn text_preview_loaded_line_count(content: &str) -> usize {
    if content.is_empty() {
        return 0;
    }
...
pub fn render_text_preview(path: &Path, content: &str) -> (String, TextPreviewFormat) {
    let format = text_preview_format_for_path(path);
    (content.to_owned(), format)
}

pub fn text_preview_format_for_path(path: &Path) -> TextPreviewFormat {
    path.extension()
