...
// 受限子进程输出读取来自共享 crate bennu-subprocess（实现由其拥有，
// spec：.trellis/spec/app-ui/bounded-child-output.md）。
use bennu_subprocess::{read_bounded_child_output, BoundedChildOutput};
