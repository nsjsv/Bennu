...
pub struct DocumentPreviewRequestKey {
    pub source_path: PathBuf,
    pub document_generation: u64,
}

#[derive(Debug, Clone, PartialEq, Eq, Hash)]
pub struct DocumentRenderKey {
    pub request: DocumentPreviewRequestKey,
    pub render_generation: u64,
    pub width_bucket: u32,
}

#[derive(Debug, Clone, PartialEq, Eq, Hash)]
pub struct DocumentPageRequestKey {
    pub render: DocumentRenderKey,
    pub page_index: usize,
}

#[derive(Debug, Clone, PartialEq, Eq, Hash)]
pub struct DocumentViewportKey {
    pub render: DocumentRenderKey,
    pub layout_generation: u64,
}

#[derive(Debug, Clone)]
pub struct DocumentPrepareRequest {
    pub key: DocumentPreviewRequestKey,
    pub max_file_bytes: u64,
    pub cancellation: CancellationToken,
}

#[derive(Debug, Clone)]
pub struct PendingDocumentPreview {
    pub key: DocumentPreviewRequestKey,
    pub cancellation: CancellationToken,
}

#[derive(Debug, Clone, Copy, PartialEq)]
pub struct DocumentPageSize {
    pub width: f64,
    pub height: f64,
...
impl DocumentPageSize {
    pub fn from_crop_box(mut width: f64, mut height: f64, rotation: i32) -> Result<Self, String> {
...
#[derive(Debug, Clone)]
pub struct PreparedDocumentPreview {
    pub key: DocumentPreviewRequestKey,
    pub workspace: Arc<DocumentPreviewWorkspace>,
    pub pages: Vec<DocumentPageSize>,
}

#[derive(Debug, Clone)]
pub enum DocumentPrepareOutcome {
...
impl DocumentPrepareOutcome {
    pub fn key(&self) -> &DocumentPreviewRequestKey {
        match self {
...
pub enum DocumentScaleAxis {
    Width(u32),
    Height(u32),
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct DocumentPageRenderPlan {
    pub width: u32,
    pub height: u32,
    pub estimated_rgba_bytes: u64,
    pub scale_axis: DocumentScaleAxis,
}

#[derive(Debug, Clone)]
pub struct DocumentPageRenderRequest {
    pub key: DocumentPageRequestKey,
    pub workspace: Arc<DocumentPreviewWorkspace>,
    pub plan: DocumentPageRenderPlan,
    pub document_cancellation: CancellationToken,
    pub render_cancellation: CancellationToken,
}

#[derive(Debug, Clone)]
pub struct DocumentPageRenderResult {
    pub key: DocumentPageRequestKey,
...
#[derive(Debug, Clone)]
pub enum DocumentPageRenderOutcome {
...
impl DocumentPageRenderOutcome {
    pub fn key(&self) -> &DocumentPageRequestKey {
        match self {
...
#[derive(Debug, Clone)]
pub enum DocumentPreviewMessage {
...
#[derive(Debug, Clone)]
pub struct PagedDocumentPreview {
...
impl PagedDocumentPreview {
    ...
    pub fn render_key(&self) -> DocumentRenderKey {
        DocumentRenderKey {
    ...
    pub fn viewport_key(&self) -> DocumentViewportKey {
        DocumentViewportKey {
    ...
    pub fn wanted_pages(&self) -> &[usize] {
        &self.wanted_pages
    }

    pub fn page_layout(&self, page_index: usize) -> Option<DocumentPageLayout> {
    ...
    pub fn page_view(&self, page_index: usize) -> DocumentPageView<'_> {
    ...
    pub fn resize(&mut self, preview_width: f32, preview_height: f32) -> Result<f32, String> {
    ...
    pub fn accept_page_outcome(&mut self, outcome: DocumentPageRenderOutcome) -> bool {
    ...
    pub fn document_cancellation(&self) -> CancellationToken {
    ...
    pub fn current_render_pages(&self) -> &[usize] {
    ...
    pub fn ready_rgba_bytes(&self) -> u64 {
...
pub fn document_page_width(preview_width: f32) -> f32 {
    (preview_width - 2.0 * DOCUMENT_PAGE_SIDE_MARGIN).max(1.0)
}

pub fn document_viewport_height(preview_height: f32) -> f32 {
