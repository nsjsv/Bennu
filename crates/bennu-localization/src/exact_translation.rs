...
pub(crate) fn translate(text: &str) -> Option<&'static str> {
    match text {
        ...
        "New File" => Some("新建文件"),
        "Advanced New Folder" => Some("高级新建文件夹"),
        "Name list" => Some("名字列表"),
        "Numbered" => Some("编号批量"),
        "Prefix" => Some("前缀"),
        "Start" => Some("起始"),
        "Count" => Some("数量"),
        "Folders" => Some("文件夹"),
        "No folders to create" => Some("没有要创建的文件夹"),
        "Auto-renamed" => Some("已自动改名"),
        "Enter after creation" => Some("创建后进入"),
        "Open in new tab after creation" => Some("创建后在新标签页进入"),
        "Move selected items into the first folder" => Some("把选中项移入第一个文件夹"),
