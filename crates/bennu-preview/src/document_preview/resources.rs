...
pub const MAX_READY_DOCUMENT_PAGES: usize = 6;
pub const MAX_READY_DOCUMENT_RGBA_BYTES: u64 = 64 * 1024 * 1024;
pub const MAX_DOCUMENT_PAGE_EDGE: u32 = 4096;
pub const MAX_DOCUMENT_PAGE_PIXELS: u64 = 16 * 1024 * 1024;
